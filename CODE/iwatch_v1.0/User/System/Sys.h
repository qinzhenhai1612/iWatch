...
#define EE_ADDRESS1  0x0180         //地址为什么是这个
...
#define LAST_FUNC    SETTING     //第二个功能
...
struct sys_config{
	...
	unsigned char key_sound;    			//按键是否有声音
	unsigned char alarm_hour;
	unsigned char alarm_min;
	unsigned char alarm_day;
	unsigned char alarm_weekday;
	unsigned char alarm_mode;         //收音机的模式
	unsigned char radio_volume; 			//收音机的音量
