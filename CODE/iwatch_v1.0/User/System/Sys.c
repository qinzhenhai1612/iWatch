...
void PinInit()
{
	...
	//P10,P11 是串口2
	//P12,P13为显示屏D/C,RES引脚，(V1.0:P12=CS,P14=D/C)
	//P14,P15为 IIC引脚，外部接入了上拉电阻，故设置为开漏          
	//P16为蓝牙使能引脚，高电平时进入低功耗
	//P17为充电使能引脚，高阻时使能充电（V1.0 ：需要飞线以支持）
	//P13 = 1; //显示屏的RES 拉高   （V1.0版本为D/C）
	P13 = 1;    
	P16 = 1; 
	P1M0 = 0x30;  //00110000b
	P1M1 = 0xb0;  //10110000b
	//P20为LED驱动引脚，强推挽模式；（V1.0 为P35）
	//P21,P22为外部拓展引脚； 
	//P23为按键UP
