...
/**
  * @brief  设置时间，输入十进制时间参数
	*					例：PCF8563WriteTime(23, 59, 50);	设定时间为12：59：50
...
/**
  * @brief  设置日期，输入十进制日期参数
	*					例：PCF8563WriteDate(2020, 3, 3, 1);
	*					设定日期为2020年3月3日周一
	* @param  year,month,day,weekday：年，月，日，星期(周一至周七对应1~7)
  * @retval None
  */
